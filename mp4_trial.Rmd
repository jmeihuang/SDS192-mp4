...
ggplot(female, aes(x = genre, y = total, fill = genre)) +
  ...
  theme(axis.text.x = element_text(angle = 90, hjust = 0.4, size = 12),
        ...
        legend.text = element_text(family = "Century Gothic", face = "bold", size = 12),
        legend.title = element_text(family = "Century Gothic", face = "bold", size = 13))
```
...
ggplot(test, aes(x = production_year, y = total/1000))+
  ...
  scale_color_manual("Gender",labels = c("Female", "Male"), values = fill_c)+
   theme(axis.text.x = element_text(angle = 90, hjust = 0.4, size = 12), 
        ...
        plot.title = element_text(family = "Century Gothic", 
                                    color = "black", face = "bold", size = 20),
        strip.text = element_text(family = "Century Gothic", face = "bold", size = 12),
        legend.text = element_text(family = "Century Gothic", face = "bold", size = 12),
        legend.title = element_text(family = "Century Gothic", face = "bold", size = 13))+
